  ...
  return (
    <div className='text-center rounded-md w-[40vw] p-[1rem] backdrop-grayscale'>
      ...
      <div className='mx-[1rem] p-[1rem] bg-stacked-peaks bg-contain hover:bg-cover rounded-b-md h-[5rem] hover:h-[12rem] transition-all'>
        <div className='flex items-center justify-center gap-[1rem] rounded-md h-[3rem] hover:h-[10rem] p-[1rem] text-2xl hover:bg-gray-500 hover:bg-opacity-25 hover:text-xl transition-all'>
          {lang?.map((i) => (
      ...
      <div className='mx-[1rem] mt-[1rem] p-[1rem] bg-stacked-waves bg-cover filter hover:hue-rotate-15 rounded-md h-[4rem] hover:font-extrabold transition-all'>
        <div className='flex items-center h-[2rem] justify-center gap-[1rem] '>
          {frameworks?.map((i) => (
            <div key={Math.random()}>{i}</div>
          ))}
        </div>
